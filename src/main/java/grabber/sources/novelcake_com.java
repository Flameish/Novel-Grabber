...
public class novelcake_com implements Source {
    private final String name = "NovelCake";
    private final String url = "https://novelcake.com/";
    private final boolean canHeadless = false;
    private Novel novel;
    private Document toc;

    public novelcake_com() {
    }

    public novelcake_com(Novel novel) {
        this.novel = novel;
    }
    ...
    public List<Chapter> getChapterList() {
        ...
        try {
            ...
            Connection.Response res = Jsoup.connect("https://novelcake.com/wp-admin/admin-ajax.php")
                    .cookies(novel.cookies)
                    .data("action","manga_get_chapters")
                    .data("manga",toc.selectFirst(".wp-manga-action-button").attr("data-post"))
    ...
    public NovelMetadata getMetadata() {
        ...
        if (toc != null) {
            Element title = toc.selectFirst(".post-title h1");
            Element author = toc.selectFirst(".author-content");
            Element desc = toc.selectFirst(".description-summary");

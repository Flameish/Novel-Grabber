...
public class veratales_com implements Source {
    private final String name = "Veratales";
    private final String url = "https://veratales.com/";
    private final boolean canHeadless = false;
    private Novel novel;
    private Document toc;

    public veratales_com(Novel novel) {
        this.novel = novel;
    }

    public veratales_com() {
    }

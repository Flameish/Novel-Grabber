...
public class example_com implements Source {
    ...
    public NovelMetadata getMetadata() {
        ...
        if(toc != null) {
            metadata.setTitle(toc.selectFirst("").text());
            metadata.setAuthor(toc.selectFirst("").text());
            metadata.setDescription(toc.selectFirst("").text());
            metadata.setBufferedCover(toc.select("").attr("abs:src"));

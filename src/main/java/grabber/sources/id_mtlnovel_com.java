...
public class id_mtlnovel_com implements Source {
    private final String name = "ID MTLNovel";
    private final String url = "https://id.mtlnovel.com";
    private final boolean canHeadless = false;
    private Novel novel;
    private Document toc;

    public id_mtlnovel_com(Novel novel) {
        this.novel = novel;
    }

    public id_mtlnovel_com() {
    }
    ...
    public NovelMetadata getMetadata() {
        ...
        if (toc != null) {
            ...
            Element author = toc.selectFirst("tr:contains(Author) td:last-child");
